        ...
        <ReservationContentCol>
          ...
          <ReservationContentRow>
            <ul>
              <li>예약 전 확인 사항</li>
              <li>
                보호자가 없는 미성년자 및 반려동물 동반시 입실하실 수 없습니다.
              </li>
              <li>
          ...
          <ReservationContentRow>
            <ul>
              <li>비치도구 / 조리도구</li>
              <li>
                · 기본 - 3구 인덕션, 전자렌지, 후라이팬(大,小), 냄비(大,小),
                집게, 가위, 국자, 주걱, 뒤집개, 감자칼, 채반, 칼, 도마,
                스패출러, 조리용 젓가락, 와인잔, 와인오프너, 전기커피포트
              </li>
              <li>
              ...
              <li>· 제공 소모품 롤유산지, 짤주머니</li>
              <li>
                · 기타 소모품(생일초, 접착포장비닐, 케익상자 등)은 별도
                준비하셔야 합니다.(추후 판매예정)
              </li>
            </ul>
          </ReservationContentRow>
